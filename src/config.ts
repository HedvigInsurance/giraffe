...
const AWS_ELASTICSEARCH_ENDPOINT = process.env.AWS_ELASTICSEARCH_ENDPOINT || ''

const AWS_ELASTICSEARCH_ACCESS_KEY_ID =
  process.env.AWS_ELASTICSEARCH_ACCESS_KEY_ID || ''
const AWS_ELASTICSEARCH_SECRET_ACCESS_KEY =
  process.env.AWS_ELASTICSEARCH_SECRET_ACCESS_KEY || ''
